...
Our core findings do not require external semantic data; nevertheless, the decision stage offers a natural interface for optional spatial covariates (e.g., POI/land-use or census attributes), which can improve corridor diversity in ablations.
