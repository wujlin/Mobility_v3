...
# Essay 冲刺写作指南（基于真实结果｜Legacy dt30 / Phase B）

> 说明：该指南对应 legacy 深圳 dt30 / Phase B 的报告写法，已归档。  
> Phase D（WorldTrace×Detroit，Behavioral Reference Frame 主线）写作请使用：`docs/ESSAY_QUICK_GUIDE.md`
...
3) 发现并量化了宏观收缩瓶颈，给出可复现诊断与下一步可验证的修复路线。
